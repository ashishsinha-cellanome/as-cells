...
if not os.path.exists(os.path.join(BASE_PATH, COMBINED_DATASET_NAME, 'images', 'train')):
...
for dataset_type in ['test', 'train']: 
    ...
    for dataset_name in DATASET_LIST:
        all_images[dataset_type] += os.listdir(os.path.join(BASE_PATH, dataset_name, 'images', dataset_type))
...
for dataset_type in ['test', 'train']:
    for dataset_name in DATASET_LIST:
        source_dir_images = os.path.join(BASE_PATH, dataset_name, 'images', dataset_type)
        source_dir_masks = os.path.join(BASE_PATH, dataset_name, 'masks', dataset_type)
        dest_dir_images = os.path.join(BASE_PATH, COMBINED_DATASET_NAME, 'images', dataset_type)
        dest_dir_masks = os.path.join(BASE_PATH, COMBINED_DATASET_NAME, 'masks', dataset_type)
