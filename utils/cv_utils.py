...
def get_num_partial_objects(
    ...
    partial_object_area_threshold: float = 0.25,
) -> int:
    ...
    for idx in overlapping_idxs:
        ...
        if (
            overlap >= 1 - partial_object_area_threshold
            or overlap < partial_object_area_threshold
        ):
            continue
...
def show_detections(
    ...
    predictions: Dict[str, Union[list, np.array]],
