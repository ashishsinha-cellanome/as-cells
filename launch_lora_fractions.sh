...
for frac in "${fractions[@]}"; do
	...
	+data.eval_batch_size=64 \
        ...
        data.target_datasets='[20240905_u87-adhered_10x_caged_4_class,20250108_neuron-adhered_10x_uncaged_4_class,20250305_neuron-adhered_10x_uncaged_4_class,240213_imr90_multichannel_overlay_4_class,20250820_c8d1a_astrocytes-adherent_10x_caged_4_class]' \
