...
# ---------------- CONFIGURATION ----------------
ODIN0_USER="asinha" # Update if your username on odin0 is different
ODIN0_HOST="odin0"  # Update with the actual address of odin0 if needed
DEST_BASE="/path/to/odin0/checkpoints" # Update this to the folder where you want to save them on odin0
# -----------------------------------------------
