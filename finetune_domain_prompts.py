...
def main(config: DictConfig):
    ...
    print("Injecting Domain-Specific Prompts into Decoder Queries...")
    # (Scaffolding: Modify model.model.transformer.decoder.query_embed to conditionally add domain embeddings)
