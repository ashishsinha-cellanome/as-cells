...
def test_ema():
    ...
    print("Initial weight equality:", torch.allclose(model.conv.weight, ema.module.conv.weight))
    ...
    print("EMA weight changed after update:", not torch.allclose(ema.module.conv.weight, model.conv.weight))
    ...
    val = sd['conv.weight']
    val.add_(5.0)
    print("Direct state_dict modification updates parameter:", torch.allclose(ema.module.conv.weight, val))
