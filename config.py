...
CLASS_NAMES_TO_USE_FOR_CROP_OVERLAPS = [
    "cell",
    "cell-adhered",
    "soma",
]  # 'cage']
...
MODELS = {
    "mask2former": {
        ...
        "weights_path": os.path.join(
            MODEL_CKPT_DIR,
            "mask2former_checkpoints/20250312_mask2former_sets_1_2_3_6_to_41_0p1_bbox_0p7_1_rs_0p25_blur_2_bs_8_epochs_1cl_lrs.pt",
        ),
    ...
    "mask-rcnn": {
        ...
        "weights_path": os.path.join(
            MODEL_CKPT_DIR,
            "mask_rcnn_checkpoints/updated-20240923_sets_1_2_3_6_to_38_0p1_bbox_0p7_1_rs_0p25_blur_2_bs_8_epochs_1cl_lrs.pt",
        ),
    ...
    "deformable-detr": {
        ...
        "weights_path": os.path.join(
            MODEL_CKPT_DIR,
            "deformable_detr_with_sam_checkpoints/20250511_deformable_detr_sam.pt",
        ),
    ...
    "rf-detr": {
        ...
        "weights_path": os.path.join(
            MODEL_CKPT_DIR,
            "rf_detr_checkpoints/updated-20250410_rf_detr_best_total.pth",
        ),
        "model_name": "RF-DETR",
        "task_type": "object_detection",
        "backbone_name_str": "sam",
    ...
    "rt-detr-v1": {
        ...
        "weights_path": os.path.join(
            MODEL_CKPT_DIR,
            "rt_detr_v1_default/20250331_sets_1_2_3_6_to_41_rt_detr_16_bs_10_epochs.pt",
        ),
    ...
    "rt-detr-v2": {
        ...
        "weights_path": os.path.join(
            MODEL_CKPT_DIR,
            "rt_detr_v2_with_dinov2_fpn_2_7_12/20250603_sets_1_2_3_6_to_41_rt_detrv2_with_dinov2_fpn_2_7_12_16_bs_10_epochs.pt",
        ),
